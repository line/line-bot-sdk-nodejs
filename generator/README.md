# OpenAPI Generator for the line-bot-sdk-nodejs-generator library
...
|--- main
|---- java
|----- line.bot.generator.LineBotSdkNodejsGeneratorGenerator.java // generator file
|---- resources
|----- line-bot-sdk-nodejs-generator // template files
|----- META-INF
|------ services
...
`LineBotSdkNodejsGeneratorGenerator.java`

Templates in this folder:

`src/main/resources/line-bot-sdk-nodejs-generator`
...
The `LineBotSdkNodejsGeneratorGenerator.java` has comments in it--lots of comments.  There is no good substitute
for reading the code more, though.  See how the `LineBotSdkNodejsGeneratorGenerator` implements `CodegenConfig`.
That class has the signature of all values that can be overridden.

You can also step through LineBotSdkNodejsGeneratorGenerator.java in a debugger.  Just debug the JUnit
