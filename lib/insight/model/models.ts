...
let enumsMap: {[index: string]: any} = {
        "AgeTile.AgeEnum": AgeTile.AgeEnum,
        "AppTypeTile.AppTypeEnum": AppTypeTile.AppTypeEnum,
        "GenderTile.GenderEnum": GenderTile.GenderEnum,
        "GetNumberOfFollowersResponse.StatusEnum": GetNumberOfFollowersResponse.StatusEnum,
        "GetNumberOfMessageDeliveriesResponse.StatusEnum": GetNumberOfMessageDeliveriesResponse.StatusEnum,
        "SubscriptionPeriodTile.SubscriptionPeriodEnum": SubscriptionPeriodTile.SubscriptionPeriodEnum,
}

let typeMap: {[index: string]: any} = {
    "AgeTile": AgeTile,
    "AppTypeTile": AppTypeTile,
    "AreaTile": AreaTile,
    "ErrorDetail": ErrorDetail,
    "ErrorResponse": ErrorResponse,
    "GenderTile": GenderTile,
    "GetFriendsDemographicsResponse": GetFriendsDemographicsResponse,
    "GetMessageEventResponse": GetMessageEventResponse,
    "GetMessageEventResponseClick": GetMessageEventResponseClick,
    "GetMessageEventResponseMessage": GetMessageEventResponseMessage,
    "GetMessageEventResponseOverview": GetMessageEventResponseOverview,
    "GetNumberOfFollowersResponse": GetNumberOfFollowersResponse,
    "GetNumberOfMessageDeliveriesResponse": GetNumberOfMessageDeliveriesResponse,
    "GetStatisticsPerUnitResponse": GetStatisticsPerUnitResponse,
    "GetStatisticsPerUnitResponseClick": GetStatisticsPerUnitResponseClick,
    "GetStatisticsPerUnitResponseMessage": GetStatisticsPerUnitResponseMessage,
    "GetStatisticsPerUnitResponseOverview": GetStatisticsPerUnitResponseOverview,
    "SubscriptionPeriodTile": SubscriptionPeriodTile,
}
