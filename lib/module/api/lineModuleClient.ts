...
export class LineModuleClient {
  ...
  public async acquireChatControl(
    ...
    const resp = await fetch(requestUrl, {
      ...
      body: JSON.stringify(acquireChatControlRequest),
    });
  ...
  public async detachModule(
    ...
    const requestUrl = new URL("/v2/bot/channel/detach", this.config.baseURL);
    ...
    const resp = await fetch(requestUrl, {
      ...
      body: JSON.stringify(detachModuleRequest),
    });
  ...
  public async getModules(
    ...
    const requestUrl = new URL("/v2/bot/list", this.config.baseURL);
