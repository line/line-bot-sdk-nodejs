...
export abstract class LineBotClientBase {
  ...
  ): Promise<channelAccessToken.ChannelAccessTokenKeyIdsResponse> {
    return this.clients.channelAccessToken.getsAllValidChannelAccessTokenKeyIds(
      clientAssertionType,
      clientAssertion,
    );
  }
  ...
  public async getsAllValidChannelAccessTokenKeyIdsWithHttpInfo(
    ...
    Types.ApiResponseType<channelAccessToken.ChannelAccessTokenKeyIdsResponse>
  > {
    return this.clients.channelAccessToken.getsAllValidChannelAccessTokenKeyIdsWithHttpInfo(
      clientAssertionType,
      clientAssertion,
    );
  }
  ...
  public async issueChannelToken(
    ...
    clientId: string,
    clientSecret: string,
  ): Promise<channelAccessToken.IssueShortLivedChannelAccessTokenResponse> {
    return this.clients.channelAccessToken.issueChannelToken(
      grantType,
      clientId,
      clientSecret,
    );
  ...
  public async issueChannelTokenWithHttpInfo(
    ...
    Types.ApiResponseType<channelAccessToken.IssueShortLivedChannelAccessTokenResponse>
  > {
    return this.clients.channelAccessToken.issueChannelTokenWithHttpInfo(
      grantType,
      clientId,
      clientSecret,
    );
  ...
  public async issueChannelTokenByJWT(
    ...
    return this.clients.channelAccessToken.issueChannelTokenByJWT(
      grantType,
      clientAssertionType,
      clientAssertion,
    );
  ...
  public async issueChannelTokenByJWTWithHttpInfo(
    ...
    Types.ApiResponseType<channelAccessToken.IssueChannelAccessTokenResponse>
  > {
    return this.clients.channelAccessToken.issueChannelTokenByJWTWithHttpInfo(
      grantType,
      clientAssertionType,
      clientAssertion,
    );
  ...
  public async issueStatelessChannelToken(
    ...
    clientId?: string,
    clientSecret?: string,
  ): Promise<channelAccessToken.IssueStatelessChannelAccessTokenResponse> {
    return this.clients.channelAccessToken.issueStatelessChannelToken(
      grantType,
      clientAssertionType,
      clientAssertion,
      clientId,
  ...
  public async issueStatelessChannelTokenWithHttpInfo(
    ...
    Types.ApiResponseType<channelAccessToken.IssueStatelessChannelAccessTokenResponse>
  > {
    return this.clients.channelAccessToken.issueStatelessChannelTokenWithHttpInfo(
      grantType,
      clientAssertionType,
      clientAssertion,
      clientId,
  ...
  public async revokeChannelTokenWithHttpInfo(
    ...
    return this.clients.channelAccessToken.revokeChannelTokenWithHttpInfo(
      accessToken,
    );
  }
  ...
  public async revokeChannelTokenByJWT(
    ...
    return this.clients.channelAccessToken.revokeChannelTokenByJWT(
      clientId,
      clientSecret,
      accessToken,
    );
  ...
  public async revokeChannelTokenByJWTWithHttpInfo(
    ...
    return this.clients.channelAccessToken.revokeChannelTokenByJWTWithHttpInfo(
      clientId,
      clientSecret,
      accessToken,
    );
  ...
  public async verifyChannelToken(
    accessToken: string,
  ): Promise<channelAccessToken.VerifyChannelAccessTokenResponse> {
  ...
  public async verifyChannelTokenWithHttpInfo(
    ...
    Types.ApiResponseType<channelAccessToken.VerifyChannelAccessTokenResponse>
  > {
    return this.clients.channelAccessToken.verifyChannelTokenWithHttpInfo(
      accessToken,
    );
  }
  ...
  public async verifyChannelTokenByJWTWithHttpInfo(
    ...
    Types.ApiResponseType<channelAccessToken.VerifyChannelAccessTokenResponse>
  > {
    return this.clients.channelAccessToken.verifyChannelTokenByJWTWithHttpInfo(
      accessToken,
    );
  }
