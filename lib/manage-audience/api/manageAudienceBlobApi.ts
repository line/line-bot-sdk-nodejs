...
export enum ManageAudienceBlobApiApiKeys {
}
...
export class ManageAudienceBlobApi {
    ...
    public setApiKey(key: ManageAudienceBlobApiApiKeys, value: string) {
        (this.authentications as any)[ManageAudienceBlobApiApiKeys[key]].apiKey = value;
    }
