...
export enum ManageAudienceApiApiKeys {
}
...
export class ManageAudienceApi {
    ...
    public setApiKey(key: ManageAudienceApiApiKeys, value: string) {
        (this.authentications as any)[ManageAudienceApiApiKeys[key]].apiKey = value;
    }
