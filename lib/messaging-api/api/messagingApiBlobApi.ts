...
export enum MessagingApiBlobApiApiKeys {
}
...
export class MessagingApiBlobApi {
    ...
    public setApiKey(key: MessagingApiBlobApiApiKeys, value: string) {
        (this.authentications as any)[MessagingApiBlobApiApiKeys[key]].apiKey = value;
    }
