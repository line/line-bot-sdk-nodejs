...
export enum ChannelAccessTokenApiApiKeys {
}
...
export class ChannelAccessTokenApi {
    ...
    public setApiKey(key: ChannelAccessTokenApiApiKeys, value: string) {
        (this.authentications as any)[ChannelAccessTokenApiApiKeys[key]].apiKey = value;
    }
