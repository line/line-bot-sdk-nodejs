...
let enumsMap: {[index: string]: any} = {
        "LiffBotPrompt": LiffBotPrompt,
        "LiffScope": LiffScope,
        "LiffView.TypeEnum": LiffView.TypeEnum,
}

let typeMap: {[index: string]: any} = {
    "AddLiffAppRequest": AddLiffAppRequest,
    "AddLiffAppResponse": AddLiffAppResponse,
    "GetAllLiffAppsResponse": GetAllLiffAppsResponse,
    "LiffApp": LiffApp,
    "LiffFeatures": LiffFeatures,
    "LiffView": LiffView,
