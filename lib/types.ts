/**
 * @deprecated Most types in this file are deprecated. Use the generated types from the sub-namespaces instead.
 * See docs/guide/migration.md for the new equivalents.
 *
 * Exceptions: `ApiResponseType<T>`, `MessageAPIResponseBase`, `LINE_REQUEST_ID_HTTP_HEADER_NAME`,
 * `LINE_SIGNATURE_HTTP_HEADER_NAME`, and `MiddlewareConfig` are still used by the current
 * generated clients and are NOT deprecated.
 */
import { AxiosRequestConfig } from "axios";

/**
 * @deprecated No single replacement. The old `Config` combined client and middleware concerns.
 * - For client usage (`channelAccessToken`): use {@link LineBotClientChannelAccessTokenConfig}.
 * - For middleware usage (`channelSecret`): use `MiddlewareConfig`.
 */
...
/**
 * @deprecated Use `messagingApi.UserProfileResponse` from `@line/bot-sdk` instead.
 */
export type Profile = {
  displayName: string;
  userId: string;
 ...
 *
 * @deprecated Use `webhook.CallbackRequest` from `@line/bot-sdk` instead.
 ...
 *
 * @deprecated Use `webhook.Event` from `@line/bot-sdk` instead.
...
/**
 * @deprecated Use `webhook.EventBase` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `webhook.Source` from `@line/bot-sdk` instead.
 */
export type EventSource = User | Group | Room;

/**
 * @deprecated Use `webhook.UserSource` from `@line/bot-sdk` instead.
 */
export type User = { type: "user"; userId: string };

/**
 * @deprecated Use `webhook.GroupSource` from `@line/bot-sdk` instead.
 */
export type Group = {
  type: "group";
  groupId: string;
...
/**
 * @deprecated Use `webhook.RoomSource` from `@line/bot-sdk` instead.
 */
export type Room = {
  type: "room";
  roomId: string;
...
/**
 * @deprecated Use `webhook.DeliveryContext` from `@line/bot-sdk` instead.
 */
export type DeliveryContext = { isRedelivery: boolean };

/**
 * @deprecated No direct equivalent. In the new API, `replyToken` is included directly in each replyable event type (e.g. `webhook.MessageEvent`).
 */
 ...
 *
 * @deprecated Use `webhook.MessageEvent` from `@line/bot-sdk` instead.
 ...
 *
 * @deprecated Use `webhook.UnsendEvent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.FollowEvent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.UnfollowEvent` from `@line/bot-sdk` instead.
 */
 ...
 *     added.
 *
 * @deprecated Use `webhook.JoinEvent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.LeaveEvent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.MemberJoinedEvent` from `@line/bot-sdk` instead.
 */
 ...
 * or [room](https://developers.line.biz/en/docs/messaging-api/group-chats/#room) that the bot is in.
 *
 * @deprecated Use `webhook.MemberLeftEvent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.PostbackEvent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.VideoPlayCompleteEvent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.BeaconEvent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.AccountLinkEvent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.PnpDeliveryCompletionEvent` from `@line/bot-sdk` instead.
...
/**
 * @deprecated Use `webhook.MessageContent` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `webhook.MessageContentBase` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.TextMessageContent` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `webhook.ContentProvider` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.ImageMessageContent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.VideoMessageContent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.AudioMessageContent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.FileMessageContent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.LocationMessageContent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `webhook.StickerMessageContent` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `webhook.PostbackContent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.Message` from `@line/bot-sdk` instead.
...
/**
 * @deprecated Use `messagingApi.MessageBase` from `@line/bot-sdk` instead.
...
/**
 * @deprecated Use `messagingApi.TextMessage` from `@line/bot-sdk` instead.
...
/**
 * @deprecated Use `messagingApi.ImageMessage` from `@line/bot-sdk` instead.
...
/**
 * @deprecated Use `messagingApi.VideoMessage` from `@line/bot-sdk` instead.
...
/**
 * @deprecated Use `messagingApi.AudioMessage` from `@line/bot-sdk` instead.
...
/**
 * @deprecated Use `messagingApi.LocationMessage` from `@line/bot-sdk` instead.
...
/**
 * @deprecated Use `messagingApi.StickerMessage` from `@line/bot-sdk` instead.
...
/**
 * @deprecated Use `messagingApi.ImagemapMessage` from `@line/bot-sdk` instead.
 ...
 *
 * @deprecated Use `messagingApi.TemplateMessage` from `@line/bot-sdk` instead.
 ...
 *
 * @deprecated Use `messagingApi.FlexMessage` from `@line/bot-sdk` instead.
 ...
 *
 * @deprecated Use `messagingApi.ImagemapAction` from `@line/bot-sdk` instead.
...
/**
 * @deprecated Use `messagingApi.ImagemapActionBase` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.URIImagemapAction` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.MessageImagemapAction` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.ImagemapArea` from `@line/bot-sdk` instead.
 */
export type Area = {
  /**
 ...
 *
 * @deprecated Use `messagingApi.FlexContainer` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.FlexBubble` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.FlexBubbleStyles` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.FlexBlockStyle` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.FlexCarousel` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.FlexComponent` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.FlexBox` from `@line/bot-sdk` instead.
 */
export type FlexBox = {
  type: "box";
  /**
...
/**
 * @deprecated Use `messagingApi.FlexBoxBackground` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.FlexButton` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.FlexFiller` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.FlexIcon` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.FlexImage` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.FlexVideo` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.FlexSeparator` from `@line/bot-sdk` instead.
 */
 ...
 * @deprecated Removed in the new API. `FlexSpacer` is not part of `messagingApi.FlexComponent`. Use `messagingApi.FlexFiller` or box padding instead.
 */
...
/**
 * @deprecated Use `messagingApi.FlexText` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.FlexSpan` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.Template` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.ButtonsTemplate` from `@line/bot-sdk` instead.
 */
 ...
 * text may not be fully displayed even when it is within the character limits.
 *
 * @deprecated Use `messagingApi.ConfirmTemplate` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.CarouselTemplate` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.CarouselColumn` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.ImageCarouselTemplate` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.ImageCarouselColumn` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.QuickReply` from `@line/bot-sdk` instead.
 */
 ...
 * [quick reply buttons](https://developers.line.biz/en/reference/messaging-api/#quick-reply-button-object).
 *
 * @deprecated Use `messagingApi.QuickReplyItem` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.Sender` from `@line/bot-sdk` instead.
 */
export type Sender = {
  /**
   * Display name
 ...
 * - [Location action](https://developers.line.biz/en/reference/messaging-api/#location-action)
 *
 * @deprecated Use `messagingApi.Action` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.PostbackAction` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.MessageAction` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.URIAction` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.AltUri` from `@line/bot-sdk` instead.
 */
export type AltURI = {
  desktop: string;
};
 ...
 *
 * @deprecated Use `messagingApi.DatetimePickerAction` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.RichMenuSize` from `@line/bot-sdk` instead.
 */
export type Size = {
  width: number;
  height: number;
 ...
 * the `uri` property is opened.
 *
 * @deprecated Use `messagingApi.RichMenuSwitchAction` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.RichMenuRequest` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.RichMenuResponse` from `@line/bot-sdk` instead.
 */
export type RichMenuResponse = { richMenuId: string } & RichMenu;

/**
 * @deprecated Use `messagingApi.NumberOfMessagesResponse` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.MessageQuotaResponse` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.QuotaConsumptionResponse` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated No direct equivalent. In the new API, the `status` field is inlined into each concrete insight response type.
 */
...
/**
 * @deprecated Use `insight.GetNumberOfMessageDeliveriesResponse` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `insight.GetNumberOfFollowersResponse` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `insight.GetFriendsDemographicsResponse` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `insight.GetMessageEventResponse` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `insight.GetStatisticsPerUnitResponse` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.Recipient` from `@line/bot-sdk` instead.
 * Note: the union structure differs — the old type used `FilterOperatorObject` wrappers,
 * while the new `Recipient` includes `OperatorRecipient` as a direct variant.
 */
...
/**
 * @deprecated Use `messagingApi.DemographicFilter` from `@line/bot-sdk` instead.
 * Note: the union structure differs — the old type used `FilterOperatorObject` wrappers,
 * while the new type includes `OperatorDemographicFilter` as a direct variant.
 */
...
/**
 * @deprecated Use `messagingApi.NarrowcastProgressResponse` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `manageAudience.AudienceGroupStatus` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `manageAudience.AudienceGroupCreateRoute` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `manageAudience.AudienceGroup` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated See docs/guide/migration.md. No direct equivalent in the new API.
 */
...
/**
 * @deprecated Use `channelAccessToken.VerifyChannelAccessTokenResponse` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.GroupSummaryResponse` from `@line/bot-sdk` instead.
 ...
 *
 * @deprecated Use `messagingApi.GroupMemberCountResponse` or `messagingApi.RoomMemberCountResponse` from `@line/bot-sdk` instead.
...
/**
 * @deprecated Use `messagingApi.RichMenuAliasResponse` from `@line/bot-sdk` instead.
 */
...
/**
 * @deprecated Use `messagingApi.RichMenuAliasListResponse` from `@line/bot-sdk` instead.
 */
 ...
 *
 * @deprecated Use `messagingApi.BotInfoResponse` from `@line/bot-sdk` instead.
 ...
 *
 * @deprecated Use `messagingApi.GetWebhookEndpointResponse` from `@line/bot-sdk` instead.
 ...
 *
 * @deprecated Use `messagingApi.TestWebhookEndpointResponse` from `@line/bot-sdk` instead.
